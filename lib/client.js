...
DivBg = React.createClass({displayName: "DivBg",
  ...
  render() {
    return (React.createElement("div", React.__spread({},  this.attrs()), this.props.children));
  }
});
...
ABg = React.createClass({displayName: "ABg",
  mixins: [ImgMixin, BgMixin],
  render() {
    return (React.createElement("a", React.__spread({},  this.attrs()), this.props.children));
  }
});
